var express = require('express'), path = require('path'), request = require('request'), ShadowBrowser = require('./shadows/browser_shadow').ShadowBrowser, ScriptServer = require('./scripts/script_server').ScriptServer, Task = require('./task').Task, _ = require('underscore'), http = require('http'), fs = require('fs');
        ...
        return new Promise(function (resolve, reject) {
            ...
            function getTask(taskId) {
                ...
                task.on('setDescription', function (event) {
                    var description = event.value, oldDescripton = event.old, oldTask = tasks[description];
                    if (oldTask) {
            ...
            io.on('connection', function (socket) {
                ...
                socket.once('clientReady', function (clientOptions) {
                    ...
                    else if (clientOptions.viewType === 'admin') {

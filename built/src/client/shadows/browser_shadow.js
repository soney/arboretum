var _ = require('underscore'), util = require('util'), EventEmitter = require('events'), ShadowTab = require('./tab_shadow').ShadowTab, ShadowFrame = require('./frame_shadow').ShadowFrame, ShadowOutput = require('./output_shadow').ShadowOutput, ShadowDOM = require('./dom_shadow').ShadowDOM;

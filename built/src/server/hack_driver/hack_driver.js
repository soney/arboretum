var _ = require('underscore'), util = require('util'), EventEmitter = require('events'), path = require('path'), fs = require('fs'), sprintf = require("sprintf-js").sprintf;
